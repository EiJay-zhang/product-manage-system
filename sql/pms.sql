...
create table pms_setting (
  ...
  eink_sync_interval_sec  int(11)         default 0          comment '墨水屏轮询间隔秒（0表示近实时5秒，V1不接MQTT）',
...
insert into sys_menu values('2206', '商品导入', '2102', '6', '', '', '', '', 1, 0, 'F', '0', '0', 'pms:product:import', '#', 'admin', sysdate(), '', null, '');
-- 分类按钮
...
insert into sys_menu values('2215', '分类导出', '2103', '5', '', '', '', '', 1, 0, 'F', '0', '0', 'pms:category:export', '#', 'admin', sysdate(), '', null, '');
-- 供应商按钮
